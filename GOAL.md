...
**Read first:** `AGENTS.md`, `V1-SCOPE.md`, `VISION.md`, `WORKSPACE-INTERACTION-SPEC.md`, the retained desktop UI kit under `Bessie Design System/ui_kits/bessie-desktop/`, and every Swift file in `Sources/BessieApp` that can render text, labels, errors, confirmations, accessibility descriptions, status, or diagnostics.
