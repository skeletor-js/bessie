...
bash -n scripts/check.sh scripts/check-ui-copy.sh scripts/mac-verify.sh scripts/package-app.sh
...
grep -Fq 'BessieProductShell(model:' Sources/BessieApp/BessieApp.swift
...
grep -Fq 'Bundle.module.url(forResource: "CowprintTile"' Sources/BessieApp/BessieDesignSystem.swift
